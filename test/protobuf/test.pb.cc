...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "onse\022P\n\017GertFriendLists\022\035.fixbug.GetFrie"
...
void UserServiceRpc::GertFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::GetFriendListsRequest*,
                         ::fixbug::GetFriendListsResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method GertFriendLists() not implemented.");
  done->Run();
}
...
void UserServiceRpc_Stub::GertFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
